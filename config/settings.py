...
LOCAL_APPS = ["myjourney.core", "myjourney.users"]
...
DATABASES = {"default": env.db("DATABASE_URL", default="postgres:///myjourney")}
...
ACCOUNT_FORMS = {"signup": "myjourney.users.forms.UserSignupForm"}
